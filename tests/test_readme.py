...
def test_status_and_progress_documents_match_current_inventory_and_coverage():
    ...
    assert "Package coverage: 60 exact login/read routes and 80 public methods" in status
    ...
    assert actual_public_methods == 80, (
...
def test_docs_document_bounded_live_p0_train_reads_and_closed_requests():
    ...
    assert "60 routes and 80 public methods" in README.read_text(encoding="utf-8")
    ...
    assert "60 routes and 80 public methods" in text
