...
def test_status_and_progress_documents_match_current_inventory_and_coverage():
    ...
    assert "Package coverage: 58 exact login/read routes and 77 public methods" in status
...
def test_docs_document_bounded_live_p0_train_reads_and_closed_requests():
    ...
    assert "58 routes and 77 public methods" in README.read_text(encoding="utf-8")
    ...
    assert "58 routes and 77 public methods" in text
