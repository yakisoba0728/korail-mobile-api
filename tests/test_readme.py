...
def test_docs_record_bounded_p0_live_counts_and_replay():
    ...
    assert (
        "current reviewed offline gate is `1861 passed, 1 deselected`" in readme
    )
    assert (
    ...
    assert (
        "current full offline release gate reports `1861 passed, 1 deselected`"
        in progress
    )
    assert (
    ...
    assert (
        "current reviewed offline gate reports `1861 passed, 1 deselected`; the "
