...
from korail_mobile_api.errors import (
    KorailAuthError, KorailProtocolError, KorailSessionExpiredError,
    KorailNoDirectTrainError, KorailApiError,
)
from korail_mobile_api.models import (
    KorailSession, TrainSearchQuery, TrainSearchContinuation, TrainSummary,
    TrainSearchResult, TransferSearchResult,
)
from korail_mobile_api.read_payloads import (
    FreeSeatCarRequest, GuideSeatConditionRequest, MergeSeatsInquiryRequest,
    PriceFareLeg, PriceFareQuoteRequest, MaasServiceDetailQuery,
)
...
ROW = {
    "h_trn_no": "7", "h_trn_gp_cd": "101", "h_trn_clsf_cd": "00",
    "h_dpt_rs_stn_cd": "0001", "h_arv_rs_stn_cd": "0099",
    "h_dpt_rs_stn_nm": "SYNTH_DEP", "h_arv_rs_stn_nm": "SYNTH_ARR",
    "h_dpt_dt": DATE, "h_dpt_tm": "090000", "h_arv_tm": "110000",
    "h_run_dt": DATE, "h_dpt_stn_run_ordr": "1", "h_arv_stn_run_ordr": "3",
    "h_dpt_stn_cons_ordr": "1", "h_arv_stn_cons_ordr": "3",
    "h_seat_att_cd": "015", "h_gd_no": "SYNTH-G", "h_trn_seq": "A",
}
TRAIN = TrainSummary.from_raw(ROW)
QUERY = TrainSearchQuery("SYNTH_DEP", "SYNTH_ARR", DATE, "090000")
SEARCH_FORM = {
    **COMMON, "txtMenuId": "11", "radJobId": "1", "selGoTrain": "109", "txtTrnGpCd": "109",
    "txtGoStart": "SYNTH_DEP", "txtGoEnd": "SYNTH_ARR", "txtGoAbrdDt": DATE, "txtGoHour": "090000",
    "txtPsgFlg_1": "1", "txtPsgFlg_2": "0", "txtPsgFlg_3": "0", "txtPsgFlg_4": "0", "txtPsgFlg_5": "0",
    "txtSeatAttCd_2": "000", "txtSeatAttCd_3": "000", "txtSeatAttCd_4": "015",
    "ebizCrossCheck": "N", "srtCheckYn": "N", "rtYn": "N", "adjStnScdlOfrFlg": "N", "qryDvCd": "1",
}
CAR_FORM = {
    **COMMON, "txtMenuId": "11", "txtPsrmClCd": "1", "txtRunDt": DATE, "txtDptDt": DATE,
    "txtDptTm": "090000", "txtTrnClsfCd": "00", "txtTrnNo": "00007", "txtDptRsStnCd": "0001",
    "txtArvRsStnCd": "0099", "txtDptStnRunOrdr": "1", "txtArvStnRunOrdr": "3", "txtTrnGpCd": "101",
    "txtTotPsgCnt": "2", "txtSeatAttCd": "015", "txtGdNo": "SYNTH-G",
}
INVENTORY_FORM = {
    **COMMON, "trnClsfCd": "00", "trnGpCd": "101", "runDt": DATE, "trnNo": "00007", "srcarNo": "2",
    "psrmClCd": "1", "dptRsStnCd": "0001", "arvRsStnCd": "0099", "seatAttCd": "015",
    "dptStnRunOrdr": "1", "arvStnRunOrdr": "3", "totPsgCnt": "2", "gdNo": "SYNTH-G", "isArrow": "false",
}
SEAT = {"seat_no": "1A", "sale_psb_flg": "Y", "dir_seat_att_cd": "001", "rq_seat_att_cd": "015",
        "seat_spec": "SYNTH", "sqr_no": "1", "intg_msg_cd": "", "intg_msg": "",
        "etc_seat_att_cd": "000", "vz_msg_dv_cd": "V", "floor": "1"}
INVENTORY = {**ENVELOPE, "layout_type": 1, "seat_ary_cd": "A", "scar_no": "2", "seatList": [SEAT],
             "windowList": [{"st_loc_rt": "0.25", "cls_loc_rt": "0.75"}], "seat_total_count": "1"}
CARS = {**ENVELOPE, "h_trn_no": "00007", "h_scar_num": "1", "h_rcmd_srcar_no": "2",
        "srcar_infos": {"srcar_info": [{"h_srcar_no": "2", "h_rest_seat_cnt": "4", "h_seat_cnt": "10",
                                      "h_psrm_cl_nm": "SYNTH_ROOM", "seatAttInfos": [{"seatAttNm": "SYNTH", "seatAttCd": "015"}]}]}}
STATIONS = {"stns": {"stn": [{"stn_cd": "0001", "stn_nm": "SYNTH_DEP", "latitude": "37.1", "longitude": "128.1"}]}}
SEARCH = {**ENVELOPE, "trn_infos": {"trn_info": [ROW]}, "h_next_pg_flg": "Y",
          "h_qry_st_no_next": "9", "h_trn_no_next": "00008"}
TRANSFER = {**SEARCH, "trn_infos": {"trn_info": [ROW, {**ROW, "h_trn_no": "8"}]},
            "h_prcd_trn_no_next": "00009", "h_ectb_trn_no_next": "00010"}
APP = {"version": {"AMESSAGE": "SYNTH", "NEWDVERSION": "9", "CNTAURL": "https://example.invalid/store"},
       "notice": {"BbrdId": "1", "PtwtSqno": "2", "PtwtTtl": "SYNTH_TITLE", "PtwtCont": "SYNTH_BODY"},
       "railplus_cardinfo": "SYNTH_CARDINFO", "unknown": {"retained": True}}
FREE_REQUEST = FreeSeatCarRequest(DATE, "7", "1", "3", "1", "3")
MERGE_REQUEST = MergeSeatsInquiryRequest(DATE + "090000", DATE + "090000", "7", "SYNTH_DEP", "SYNTH_ARR", "SYNTH_MID", "1", "015", 2)
FARE_LEG = PriceFareLeg("0001", "0099", DATE, "00007", "015", "101", "00")
FARE_REQUEST = PriceFareQuoteRequest((FARE_LEG,))
FARE_FORM = {**COMMON, "txtMenuId": "11", "chtnDvCd": "1", "trnCnt": "1", "dptRsStnCd": "0001", "arvRsStnCd": "0099",
             "runDt": DATE, "trnNo": "00007", "rqSeatAttCd": "015", "trnGpCd": "101", "stlbTrnClsfCd": "00"}

# (public method, positional args, keyword args, route, exact form, response, parsed fields, local auth)
CASES = [
    ("search_trains", (QUERY,), {}, P+"seatMovie.ScheduleView", SEARCH_FORM, SEARCH, {"trains.0.train_no": "7", "metadata.next_train_no": "00008"}, False),
    ("search_transfer_trains", (QUERY,), {}, P+"seatMovie.ScheduleView", {**SEARCH_FORM,"radJobId":"2"}, TRANSFER, {"itineraries.0.first.train_no":"7", "itineraries.0.second.train_no":"8"}, False),
    ("search_trains_with_transfer_fallback", (QUERY,), {}, P+"seatMovie.ScheduleView", SEARCH_FORM, SEARCH, {"trains.0.train_no":"7"}, False),
    ("get_train_schedule", (DATE,"7"), {}, P+"research.actualTrainSchedule.do", {**DEVICE,"runDt":DATE,"trnNo":"00007"}, {**ENVELOPE,"trnNo1":"00007","runDt1":DATE,"dlayList":[{"stopRsStnCd":"0001","stopStnNm":"SYNTH_DEP","actArvDlayTnum":2,"actDptTm":"090000"}]}, {"train_no":"00007","stops.0.station_name":"SYNTH_DEP","stops.0.actual_arrival_delay_count":"2"}, False),
    ("get_transfer_stations", ("0001","0099"), {}, P+"qry.chtnStn.do", {**COMMON,"dptRsStnCd":"0001","arvRsStnCd":"0099"}, {**ENVELOPE,"chtnList":[{"chtnRsStnCd":"0050","chtnRsStnNm":"SYNTH_MID"}]}, {"stations.0.station_code":"0050"}, False),
    ("get_train_calendar", (), {}, P+"schedule.runDt", {**COMMON,"timeStamp":"1700000000000"}, {**ENVELOPE,"runningCalendar":[{"runDt":DATE,"hldyDvCd":"N","aTrnOpFlg":"Y"}]}, {"days.0.run_date":DATE,"days.0.a_train_operation_flag":"Y"}, False),
    ("get_seat_cars", (TRAIN,), {"passenger_count":2}, P+"research.TrainResearch", CAR_FORM, CARS, {"cars.0.car_no":2,"cars.0.remaining_seat_count":4,"cars.0.attributes.0.code":"015"}, True),
    ("get_seat_inventory", (TRAIN,2), {"passenger_count":2}, P+"research.TResidualSeatsResearch.do", INVENTORY_FORM, INVENTORY, {"layout_type":"1","seats.0.seat_no":"1A","windows.0.start_location_ratio":0.25}, True),
    ("get_free_seat_car_info", (FREE_REQUEST,), {}, P+"trn.fresScar.do", {**COMMON,"runDt":DATE,"trnNo":"00007","dptStnConsOrdr":"1","arvStnConsOrdr":"3","dptStnRunOrdr":"1","arvStnRunOrdr":"3"}, {**ENVELOPE,"fresTtl":"SYNTH","fresScarNo":"2","fresCont":"SYNTH_BODY"}, {"car_no":"2","title":"SYNTH"}, False),
    ("get_guide_seat_condition", (GuideSeatConditionRequest("015"),), {}, P+"reservation.guideSeatCnd.do", {**COMMON,"rqSeatAttCd":"015"}, {"strResult":"FAIL","h_msg_cd":"MRR800011","h_msg_txt":"SYNTH_GUIDE","timeStamp":7}, {"h_msg_cd":"MRR800011","time_stamp":7}, False),
    ("get_merge_seats_inquiry", (MERGE_REQUEST,), {}, P+"research.mergeSeatsC.do", {**COMMON,"abrdDt":DATE+"090000","runDt":DATE+"090000","trnNo":"00007","dptRsStnNm":"SYNTH_DEP","arvRsStnNm":"SYNTH_ARR","psrmClCd":"1","seatAttCd":"015","totPsgNum":"2","selRsStnNm":"SYNTH_MID"}, {**ENVELOPE,"runDt":DATE,"midStnList":[{"rsStnCd":"0050","rsStnNm":"SYNTH_MID","runOrdr":"2"}],"trn_infos":{"h_merge_rsv_psb_flg":"Y","trn_info":[ROW]}}, {"intermediate_stations.0.code":"0050","merge_reservation_possible_flag":"Y","trains.0.train_no":"7"}, False),
    ("get_price_fare_quote", (FARE_REQUEST,), {}, P+"trn.prcFare.do", FARE_FORM, {**ENVELOPE,"prcList":[{"jrnySqno":"1","psrmClNm":"SYNTH_ROOM","rcvdFare":"1000","rcvdPrc":"200","sumAmt":"1200","trnNo":"00007"}]}, {"fares.0.total_amount":"1200","fares.0.train_no":"00007"}, False),
    ("get_station_info", (), {}, P+"common.stationinfo", {}, {"count":"1","map_version":"v1"}, {"count":"1","map_version":"v1"}, False),
    ("get_station_data", (), {}, P+"common.stationdata", {}, STATIONS, {"stations.0.code":"0001","stations.0.name":"SYNTH_DEP","stations.0.latitude":"37.1"}, False),
    ("get_common_code", (["SYNTH_A","SYNTH_B"],), {}, P+"common.code.do", {**COMMON,"code":["SYNTH_A","SYNTH_B"],"deviceWidth":"101","deviceHeight":"202","OSVersion":"33"}, {**ENVELOPE,"SYNTH_A":{"value":1},"SYNTH_B":[]}, {"raw.SYNTH_A.value":1}, False),
    ("get_app_data", (), {}, "/file/CACHE/prdMobilePlusMain.cache", {"timeStamp":"1700000000000"}, APP, {"version.new_version":"9","notice.post_title":"SYNTH_TITLE"}, False),
    ("get_notice", (), {}, "/file/CACHE/prdMobilePlusMain.cache", {"timeStamp":"1700000000000"}, APP, {"board_id":"1","post_content":"SYNTH_BODY"}, False),
    ("get_uuid", (), {}, "/ebizcross/getUUID.do", {}, {"mutMrkVrfCd":"SYNTH-VERIFICATION"}, {"verification_code":"SYNTH-VERIFICATION"}, False),
    ("get_service_status", (), {}, "/file/CACHE/MobileService.cache", {"timeStamp":"1700000000000"}, {**ENVELOPE,"timeStamp":7}, {"h_msg_cd":"API.I00000","raw.timeStamp":7}, False),
    ("get_maas_menu_list", (), {}, P+"copt.gdMenuLt.do", {**COMMON,"timeStamp":"1700000000000"}, {**ENVELOPE,"menuList":[{"active":"Y","addSrvDvCd":"SYNTH_SERVICE","appData":"Y","type":"M","name":"SYNTH_MENU"}],"dElevatorUrl":"https://example.invalid/elevator"}, {"items.0.name":"SYNTH_MENU","departure_elevator_url":"https://example.invalid/elevator"}, False),
    ("get_maas_station_data", ("SYNTH_SERVICE",), {}, "/ebizmaas/EbizMaasStationList.do", {"addSrvDvCd":"SYNTH_SERVICE"}, STATIONS, {"stations.0.code":"0001"}, False),
    ("get_maas_service_details", (), {}, P+"copt.gdReqQry.do", DEVICE, {**ENVELOPE,"addSrvList":[{"addSrvId":"SYNTH_SERVICE","reqQnty":"1","detailInfo":{"name":"SYNTH_DETAIL","entityOne":[{"synthetic":1}]}}]}, {"details.0.additional_service_id":"SYNTH_SERVICE","details.0.detail_info.name":"SYNTH_DETAIL"}, True),
]
...
def rig():
    ...
    def make(responses, *, auth=False):
        ...
        config = KorailConfig(base_url="https://example.invalid", device=COMMON["Device"], version=COMMON["Version"],
            key=COMMON["Key"], lang=COMMON["lang"], device_width=101, device_height=202, android_sdk_int=33,
            netfunnel_enabled=False, dynapath=DynapathConfig(enabled=True, token_provider=lambda *args: "SYNTH-TOKEN"))
...
@pytest.mark.parametrize("value", [ABSENT, None, True, False, [], {}, 1.5], ids=["missing","null","true","false","list","object","float"])
...
def test_optional_integer_string_compatibility(name, wire, model, value, rig):
    ...
    """
    case = BY_NAME[name]
    raw = deepcopy(case[5]); put(raw, wire, value)
...
def test_station_info_serializer_required_mask(key, value, rig):
    ...
    raw = {"count":"1", "map_version":"1"}; put(raw, key, value)
...
def test_station_info_required_string_accepts_integers_and_empty(raw, rig):
    ...
    client, _, _ = rig([raw]); result = client.get_station_info()
...
@pytest.mark.parametrize("raw", [{}, {"stns":None}, {"stns":{}}, {"stns":{"stn":None}}, {"stns":{"stn":{}}}])
def test_station_container_required_masks(name, raw, rig):
    ...
    case = BY_NAME[name]; client, _, _ = rig([raw])
    with pytest.raises(KorailProtocolError) as error:
        getattr(client, name)(*case[1])
    assert error.value.raw == raw


@pytest.mark.parametrize("name,wire,model", [
...
def test_retained_required_guards_allow_integer_strings(name, wire, model, rig):
    ...
    case = BY_NAME[name]; raw = deepcopy(case[5]); put(raw, wire, 0)
    client, _, _ = rig([raw], auth=case[7])
    result = getattr(client, name)(*case[1], **case[2])
...
@pytest.mark.parametrize("name,wire", [
    ("get_seat_inventory","layout_type"), ("get_seat_inventory","seat_ary_cd"),
    ("get_seat_inventory","seatList.0.seat_no"), ("get_seat_inventory","seatList.0.intg_msg"),
    ...
    ("get_station_data","stns.stn.0.stn_cd"), ("get_uuid","mutMrkVrfCd"),
])
def test_document_retained_extra_presence_guards(name, wire, rig):
    ...
    """
    case = BY_NAME[name]; raw = deepcopy(case[5]); put(raw, wire, ABSENT)
    client, calls, _ = rig([raw], auth=case[7])
    with pytest.raises(KorailProtocolError) as error:
...
@pytest.mark.parametrize("key,alias,model", [("h_trn_no","trnNo","train_no"), ("h_trn_gp_cd","trnGpCd","train_group_code"),
    ("h_dpt_stn_run_ordr","dptStnRunOrdr","departure_run_order"), ("h_gd_no","txtGdNo","goods_no")])
...
def test_next_page_empty_page_and_cursor_choice(name, empty, rig):
    ...
    if empty: raw["trn_infos"]["trn_info"] = []
    client, _, _ = rig([raw]); result = getattr(client, name)(QUERY)
...
def test_numeric_zero_cursor_survives_parsing(rig):
    ...
    client, _, _ = rig([raw]); cursor = client.search_trains(QUERY).next_page()
...
def test_transfer_incomplete_cursor_policy_is_not_app_proof(rig):
    ...
    client, _, _ = rig([raw]); cursor = client.search_transfer_trains(QUERY).next_page()
...
def test_interleaved_transfer_grouping_uses_h_trn_seq_not_change_seq(rig):
    ...
    rows = [{**ROW,"h_trn_no":str(i),"h_trn_seq":seq,"h_chg_trn_seq":"SAME"}
...
def test_exact_form_options_and_three_continuation_fields(special, rig):
    ...
    query = replace(QUERY, passengers=2, child_passengers=1, senior_passengers=1, high_disability_passengers=1,
        low_disability_passengers=1, include_srt=True, seat_attribute_code="031", query_division_code="SYNTH_SORT",
        connection_station_codes=("0050","0060"), connection_train_group_code="SYNTH_GROUP")
    ...
    client.search_trains(query, continuation=TrainSearchContinuation("S","A","B"), use_special_schedule=special)
    form = {**SEARCH_FORM,"txtPsgFlg_1":"2","txtPsgFlg_2":"1","txtPsgFlg_3":"1","txtPsgFlg_4":"1","txtPsgFlg_5":"1",
        "ebizCrossCheck":"Y","srtCheckYn":"Y","txtSeatAttCd_4":"031","qryDvCd":"SYNTH_SORT","qryStNo":"S",
        "qryStTrnNo":"A","qryStTrnNo2":"B","chtnCnt":"2","chtnRsStnCd1":"0050","chtnRsStnCd2":"0060",
        "trnGpCnt":"1","trnGpCd1":"SYNTH_GROUP","mbCrdNo":"SYNTH-MEMBER"}
...
def test_numeric_station_codes_are_resolved_once_then_cached(rig):
    ...
    raw = {"stns":{"stn":[{"stn_cd":"0001","stn_nm":"SYNTH_DEP"},{"stn_cd":"0099","stn_nm":"SYNTH_ARR"}]}}
    client, calls, _ = rig([raw,SEARCH,SEARCH])
    query = replace(QUERY, departure_station_code="0001", arrival_station_code="0099")
    client.search_trains(query); client.search_trains(query)
    exact_request(calls[0],P+"common.stationdata",{})
    for request in calls[1:]: exact_request(request,P+"seatMovie.ScheduleView",SEARCH_FORM)
...
def test_direct_no_results_falls_back_once_and_resets_continuation(rig):
    ...
    result = client.search_trains_with_transfer_fallback(QUERY,continuation=TrainSearchContinuation("S","T","U"))
    assert isinstance(result,TransferSearchResult)
    exact_request(calls[0],P+"seatMovie.ScheduleView",{**SEARCH_FORM,"qryStNo":"S","qryStTrnNo":"T","qryStTrnNo2":"U"})
    exact_request(calls[1],P+"seatMovie.ScheduleView",{**SEARCH_FORM,"radJobId":"2"})


@pytest.mark.parametrize("raw,raises", [
...
def test_fallback_not_triggered_by_empty_success_or_unrelated_error(raw, raises, rig):
    ...
    client, calls, _ = rig([raw])
    if raises:
        with pytest.raises(KorailApiError): client.search_trains_with_transfer_fallback(QUERY)
    else:
...
@pytest.mark.parametrize("name", ["search_trains","get_guide_seat_condition","get_seat_inventory","get_maas_service_details"])
def test_p058_clears_session_even_on_guidance_path(name, rig):
    ...
    case = BY_NAME[name]; raw = {"strResult":"FAIL","h_msg_cd":"P058","h_msg_txt":"SYNTH_EXPIRED"}
...
def test_local_auth_guard_is_retained_not_app_equivalence(name, rig):
    ...
    case = BY_NAME[name]; client, calls, _ = rig([])
    with pytest.raises(KorailAuthError): getattr(client,name)(*case[1],**case[2])
    assert calls == []
...
def test_ticket_maas_repeated_return_numbers_and_history_dates(rig):
    ...
    exact_request(calls[0],P+"copt.gdMenuLt.do",{**COMMON,"pnrNo":"SYNTH-PNR","tkRetNo":["SYNTH-RETURN-A","SYNTH-RETURN-B"]})
...
def test_two_leg_fare_and_goods_column_order(rig):
    ...
    client,calls,_ = rig([ENVELOPE]); client.get_price_fare_quote(PriceFareQuoteRequest((first,second)))
    form = {**COMMON,"txtMenuId":"11","chtnDvCd":"2","trnCnt":"2","dptRsStnCd":"0001,0099","arvRsStnCd":"0099,0100",
        "runDt":DATE+","+DATE,"trnNo":"00007,00008","gdNo":"SYNTH-G1,SYNTH-G2","rqSeatAttCd":"015,031","trnGpCd":"101,102","stlbTrnClsfCd":"00,01"}
...
def test_optional_goods_and_seat_attribute_are_not_invented(method, rig):
    ...
    for key in ("txtGdNo","txtSeatAttCd","gdNo","seatAttCd"): expected.pop(key,None)
...
def test_notice_missing_and_optional_lists_empty(rig):
    ...
    notice=client.get_notice(); assert notice.post_title is None and notice.raw == {}
...
def test_optional_long_on_guidance_is_lenient(value,rig):
    ...
    raw={**ENVELOPE,"timeStamp":1}; put(raw,"timeStamp",value)
    client,_,_=rig([raw]); result=client.get_guide_seat_condition(GuideSeatConditionRequest("015"))
...
def test_optional_merge_flag_is_lenient_and_raw_survives(bad, rig):
    ...
    client,_,_=rig([raw]); result=client.get_merge_seats_inquiry(MERGE_REQUEST)
...
@pytest.mark.parametrize("name,container", [
    ("get_train_schedule","dlayList"), ("get_train_calendar","runningCalendar"),
    ("get_maas_menu_list","menuList"), ("get_maas_service_details","addSrvList"),
    ("get_price_fare_quote","prcList"), ("get_merge_seats_inquiry","midStnList"),
])
...
def test_optional_containers_tolerate_bad_shapes(name,container,bad,rig):
    ...
    case=BY_NAME[name]; raw=deepcopy(case[5]); raw[container]=bad
    client,_,_=rig([raw],auth=case[7])
    result=getattr(client,name)(*case[1],**case[2])
    attribute={"dlayList":"stops","runningCalendar":"days","menuList":"items","addSrvList":"details","prcList":"fares","midStnList":"intermediate_stations"}[container]
...
def test_train_no_retained_truthiness_dependent_type_guard(bad,rig):
    ...
    client,_,_=rig([raw])
    if bad:
        with pytest.raises(KorailProtocolError) as error: client.search_trains(QUERY)
        assert error.value.raw == raw
    else:
        result = client.search_trains(QUERY)
...
def test_common_code_and_status_unmodeled_values_remain_raw(rig):
    ...
    exact_request(calls[0],P+"common.code.do",{**COMMON,"code":"SYNTH_CODE","deviceWidth":"101","deviceHeight":"202","OSVersion":"33"})


@pytest.mark.parametrize("peak,special,expected", [(False,False,"inquiry"),(True,False,"peak_season_inquiry"),(False,True,"product_inquiry"),(True,True,"product_inquiry")])
def test_search_queue_gate_wraps_request_without_extra_posts(peak,special,expected,rig):
    ...
    client,calls,_=rig([SEARCH]); events=[]
    class LocalQueue:
        def run(self,gate,send):
            events.append((gate,"enter",len(calls)))
            try: return send()
            finally: events.append((gate,"exit",len(calls)))
        def close(self): pass
...
def test_cars_then_inventory_stays_two_read_posts(rig):
    ...
    assert [r.url.path for r in calls] == [P+"research.TrainResearch",P+"research.TResidualSeatsResearch.do"]
