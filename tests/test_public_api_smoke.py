...
def _f8_arguments() -> dict[str, dict[str, Any]]:
    ...
    result: dict[str, dict[str, Any]] = {
        "login": {"member_no": "0000000000", "password": "SYNTHETIC-PASSWORD"},
        "logout": {},
        "clear_session": {},
        "close": {},
        ...
        "refund": {
            ...
            "commission": api.RefundCommissionResponse(str_result="SUCC"),
        },
