...
The reviewed package boundary contains 61 routes and 77 public methods. Fifty-nine
...
read-only allowlist. Sixty-five of the methods transmit only login/read requests.
...
`2245 passed, 1 deselected`, where the one deselected test is the explicitly
