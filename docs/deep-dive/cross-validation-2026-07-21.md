...
- SDK config keys (from `res/values/strings.xml`): `google_api_key=<KORAIL-APP-GOOGLE-API-KEY-REDACTED>` (:894); `google_app_id=<KORAIL-APP-GOOGLE-APP-ID-REDACTED>` (:895); gcm sender `303574505999`; firebase project `<KORAIL-APP-FIREBASE-PROJECT-REDACTED>` (:1523); `kakao_app_key=<KORAIL-APP-KAKAO-APP-KEY-REDACTED>` (:947).
