...
- **비식별화가 다시 망가지는 것을 막는 가드 여섯.** 뭉개진 한글, 한국 밖의 좌표,
  날짜·시각이 아닌 날짜·시각 필드, 열차 운임일 수 없는 금액, 자릿수가 맞지 않는
  개수·순번, 백분율이 아닌 비율. 여섯 다 취향이 아니라 **실제로 새어 나온 것**에
  대응합니다 — 이 목록의 Fixed 에 적은 사고가 그것입니다. 가드가 보는 키는 64종이고,
  각 가드는 심어 둔 오염을 실제로 떨어뜨리는지 확인했습니다.
