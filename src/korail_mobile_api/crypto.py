...
def transform_login_password(password: str, info: LoginCryptoInfo) -> str:
    ...
    근거: LoginRepositoryImpl.java:929-931,1245 및 AESCrypto.java:182. 앱은 빈 키를
    재조회합니다(LoginRepositoryImpl.java:1230-1234). 이 함수는 재조회하지 않고 빈 키·지원하지 않는 길이를 KorailProtocolError 로
    거절하여 평문 폴백을 막습니다. 키 구성 근거: AESCrypto.java:45-57.
    """
